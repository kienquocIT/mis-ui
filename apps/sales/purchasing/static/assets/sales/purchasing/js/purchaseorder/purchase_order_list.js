                ...
                columns: [
                    ...
                    },
                    {
                        ...
                        render: (data, type, row) => {
                            ...
                            return `<div class="d-flex align-items-center justify-content-between"><span>${sttTxt[row?.['receipt_status']][1]}</span><i class="fas fa-check text-success fs-4" ${hidden}></i></div>`;
                        }
                    },
                    {
                        targets: 7,
