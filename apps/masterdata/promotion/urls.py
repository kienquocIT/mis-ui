...
from apps.masterdata.promotion.views import PromotionList, PromotionCreate, \
    PromotionListAPI, PromotionCreateAPI, PromotionDetail, PromotionDetailAPI, PromotionCheckListAPI, PromotionEdit
...
urlpatterns = [
    ...
    path('edit/<str:pk>', PromotionEdit.as_view(), name='PromotionEdit'),
