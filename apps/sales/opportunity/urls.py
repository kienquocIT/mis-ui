...
urlpatterns = [
                  ...
                  path(
                      'api/<str:pk_opp>/member/add', MemberOfOpportunityDetailAddAPI.as_view(),
                      name='MemberOfOpportunityDetailAddAPI'
                  ),
                  path(
                      'api/<str:pk_opp>/member/<str:pk_member>', MemberOfOpportunityDetail.as_view(),
                      name='MemberOfOpportunityDetail'
                  ),
                  path(
    ...
    path('api/call-log/<str:pk>', OpportunityCallLogDetailAPI.as_view(), name='OpportunityCallLogDetailAPI'),
    ...
    path('api/send-email/<str:pk>', OpportunityEmailDetailAPI.as_view(), name='OpportunityEmailDetailAPI'),
    ...
    path('api/meeting/<str:pk>', OpportunityMeetingDetailAPI.as_view(), name='OpportunityMeetingDetailAPI'),
    ...
    path(
                  ...
                  path(
                      'document/detail/<str:pk>', OpportunityDocumentDetail.as_view(), name='OpportunityDocumentDetail'
                  ),

                  path('document/list/api', OpportunityDocumentListAPI.as_view(), name='OpportunityDocumentListAPI'),
                  path(
                      'document/list/api/<str:pk>', OpportunityDocumentDetailAPI.as_view(),
                      name='OpportunityDocumentDetailAPI'
                  ),
              ] + [
                  path(
                      'member/detail/api/<str:pk>', OpportunityMemberDetailAPI.as_view(),
                      name='OpportunityMemberDetailAPI'
                  ),
                  ...
                  path('member/list/api/<str:pk>', OpportunityMemberListAPI.as_view(), name='OpportunityMemberListAPI'),
              ]
