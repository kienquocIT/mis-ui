                    ...
                    },
                    {
                        ...
                        render: (data, type, row) => {
                            if (Object.keys(row.opportunity_mapped).length !== 0) {
                                ...
                                return `Quo <span><a class="link-secondary underline_hover" href="${dtb.attr('data-url-quo-detail').replace('0', row.quotation_mapped.id)}"><b>${row.quotation_mapped.title}</b></a></span>`
                            }
                            else if (Object.keys(row.sale_order_mapped).length !== 0) {
                                return `SO <span><a class="link-secondary underline_hover" href="${dtb.attr('data-url-so-detail').replace('0', row.sale_order_mapped.id)}"><b>${row.sale_order_mapped.title}</b></a></span>`
                            }
                            else {
                                return ''
                            }
