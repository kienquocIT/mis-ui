    ...
    let config = {
        ...
        columns: [{
            ...
            'className': 'action-center', 'render': (data, type, row, meta) => {
                ...
                let bt2 = `<a class="btn btn-icon btn-flush-dark btn-rounded flush-soft-hover" data-bs-toggle="tooltip" data-bs-placement="top" title="" data-bs-original-title="Edit" href="/organization/group/update"><span class="btn-icon-wrap"><span class="feather-icon"><i data-feather="edit"></i></span></span></a>`;
    ...
    function loadDataTable() {
        ...
        $.fn.callAjax(tb.attr('data-url'), tb.attr('data-method')).then(
            (resp) => {
                ...
                if (data) {
                    if (data.hasOwnProperty('group_list')) config['data'] = data.group_list;
