$(document).ready(function () {
                    ...
                    },
                    {
                        ...
                        render: (row, type, data, meta) => {
                            ...
                            html.find('.f_mor').attr('id', `f_mor_${meta.row}`).attr('name', `morning_shift_f_${
                                meta.row}`).val('true').next('label').attr('for', `f_mor_${meta.row}`)
                            html.find('.f_aft').attr('id', `f_aft_${meta.row}`).attr('name', `morning_shift_f_${
                                meta.row}`).val('false').next('label')
                                .attr('for', `f_aft_${meta.row}`)
                    ...
                    },
                    {
                        ...
                        render: (row, type, data, meta) => {
                            ...
                            html.find('.f_mor').attr('id', `t_mor_${meta.row}`).attr('name', `morning_shift_t_${
                                meta.row}`).val('true').next('label').attr('for', `t_mor_${meta.row}`)
                            html.find('.f_aft').attr('id', `t_aft_${meta.row}`).attr('name', `morning_shift_t_${
                                meta.row}`).val('false').next('label').attr('for', `t_aft_${meta.row}`)
                            html.find('.date-picker').attr('name', `date_to_${meta.row}`)
                                .attr('id', `InputDateTo_${meta.row}`)
    ...
    // first of all load employee inherit dropdown, prepare for available list and detail tab list
