...
!function (e) {
    ...
    function s(t, r) {
        ...
        if (this.c = a.extend(!0, {}, p.defaults.rowGroup, s.defaults, r), this.s = {dt: new p.Api(t)}, this.dom = {}, r = this.s.dt.settings()[0], t = r.rowGroup) return t;
    ...
    return a.extend(s.prototype, {
        ...
        _constructor: function () {
            var e = this, t = this.s.dt, n = t.settings()[0];
        ...
        _draw: function () {
            var t = this.s.dt, t = this._group(0, t.rows({page: "current"}).indexes());
        ...
        _groupDisplay: function (t, r) {
            for (var e, n = this.s.dt, o = 0, a = r.length; o < a; o++) {
                var s, i = r[o], u = i.dataPoint, d = i.rows;
