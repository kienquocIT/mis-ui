$(function () {
    $(document).ready(function () {
        ...
        function loadDbl() {
            let $table = $('#table_goods_recovery_list')
            ...
            $table.DataTableDefault({
                ...
                ajax: {
                    ...
                    dataSrc: function (resp) {
                        ...
                        if (data && resp.data.hasOwnProperty('goods_recovery_list')) {
                            return resp.data['goods_recovery_list'] ? resp.data['goods_recovery_list'] : []
                        }
