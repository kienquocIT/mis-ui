...
class ApiURL:  # pylint: disable=too-few-public-methods
    ...
    CHART_OF_ACCOUNT_TYPE_TREE_LIST = StringUrl('accounting-report/chart-of-accounts/type-tree')
    CHART_OF_ACCOUNT_GROUP_LIST = StringUrl('accounting-report/chart-of-accounts-group-list')
    CHART_OF_ACCOUNTS_SUMMARIZE = StringUrl('accounting-setting/get_chart_of_accounts_summarize')
