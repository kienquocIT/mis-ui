...
from apps.hrm.absenceexplanation.views import AbsenceExplanationList, AbsenceExplanationCreate, \
    AbsenceExplanationListAPI, AbsenceExplanationDetail, AbsenceExplanationDetailAPI, AbsenceExplanationEdit
...
urlpatterns = [
    ...
    path('detail/api/<str:pk>', AbsenceExplanationDetailAPI.as_view(), name='AbsenceExplanationDetailAPI'),
    path('update/<str:pk>', AbsenceExplanationEdit.as_view(), name='AbsenceExplanationEdit'),
]
