...
$(document).ready(async function() {
    ...
    await ServiceOrderPageHandler.loadServiceOrderData('#form-detail-service-order', true);
    ...
    handleDetailEvents()
    ServiceOrderPageHandler.setupIndicatorCanvas('#form-detail-service-order')
});