$(document).ready(function () {
    function loadDataTable() {
        let $table = $('#table-fixed-asset-write-off-list')
        ...
        $table.DataTableDefault({
            ...
            ajax: {
                ...
                dataSrc: function (resp) {
                    ...
                    if (data && resp.data.hasOwnProperty('fixed_asset_writeoff_list')) {
                        return resp.data['fixed_asset_writeoff_list'] ? resp.data['fixed_asset_writeoff_list'] : []
                    }
