$(function () {
    $(document).ready(function () {
        ...
        $('#form-create-purchase-quotation-request').submit(function (event) {
            ...
            frm.dataForm['purchase_request_list'] = $('#purchase-request-select-box').val();
            ...
            $('#table-purchase-quotation-request-products-selected tbody tr').each(function (index, element) {
                frm.dataForm['products_selected'].push(
                    {
                        'product_id': $(this).find('.product-title').attr('data-product-id'),
                        'product_description': $(this).find('.product-description').val(),
                        'product_uom_id': $(this).find('.product-uom').attr('data-product-uom-id'),
                        'product_quantity': $(this).find('.product-quantity').text(),
