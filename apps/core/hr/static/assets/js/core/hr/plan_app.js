            ...
            columns: [
                {
                    ...
                    render: function (data, type, row, meta) {
                        ...
                        return `
                            <span class="badge badge-indigo">${license_used >= 0 ? license_used : 0} / ${typeof license_quantity == 'number' ? license_quantity : $.fn.storageSystemData.attr('data-msg-unlimited')}</span>
                        `;
                    }
                }
            ],
