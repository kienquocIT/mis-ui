...
from apps.sales.dashboard.views import (
    DashboardGeneralList, DashboardPipelineList, DashboardCommonPage, DashboardServiceOrderList
)
...
urlpatterns = [
    ...
    path('service-order', DashboardServiceOrderList.as_view(), name='DashboardServiceOrderList'),
]
