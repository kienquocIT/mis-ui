...
from apps.sales.report.views import (
    ...
    ReportCashflowList, ReportCashflowListAPI, ReportInventoryDetailListAPI, ReportInventoryList,
    ReportInventoryListAPI, ReportGeneralList, ReportGeneralListAPI
)
