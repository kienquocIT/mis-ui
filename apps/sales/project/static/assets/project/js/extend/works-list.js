$(document).ready(function(){
    ...
    const status_data = [
        {txt: $.fn.gettext("To do"), cls: "soft-secondary"},
        {txt: $.fn.gettext("In progress"), cls: "soft-primary"},
        {txt: $.fn.gettext("Pending"), cls: "soft-warning"},
        {txt: $.fn.gettext("Completed"), cls: "soft-success"},
    ]
