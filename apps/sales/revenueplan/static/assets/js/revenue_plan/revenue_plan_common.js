...
class RevenuePlanPageFunction {
    ...
    static getMonthOrder(space_month) {
        for (let i = 0; i < 12; i++) {
            ...
            $(`#m${i+1}th`).text(pageElements.$trans_script.attr(`data-trans-m${trans_order}th`))
        }
    }
    ...
    static LoadPeriod(data) {
        pageElements.$revenuePlanPeriodEle.initSelect2({
            ...
            if (selected_option) {
                RevenuePlanPageFunction.getMonthOrder(selected_option['space_month'])
            }
        })
    }
            ...
            columns: [
                ...
                },
                {
                    ...
                    render: (data, type, row) => {
                        ...
                        return `<input ${option==='detail' ? 'disabled readonly' : ''} value="${row.emp_month_target[0] || 0}" data-return-type="number" class="mb-1 mask-money form-control month-target quarter1belong m1targetvalue">
                                <input ${option==='detail' ? 'disabled readonly' : ''} value="${row.emp_month_profit_target[0] || 0}" data-return-type="number" class="net-income-form-control mask-money form-control month-target-profit quarter1belong-profit m1targetvalue-profit">`
                    }
                },
                {
                    className: 'w-5',
                    render: (data, type, row) => {
                        ...
                        return `<input ${option==='detail' ? 'disabled readonly' : ''} value="${row.emp_month_target[1] || 0}" data-return-type="number" class="mb-1 mask-money form-control month-target quarter1belong m2targetvalue">
                                <input ${option==='detail' ? 'disabled readonly' : ''} value="${row.emp_month_profit_target[1] || 0}" data-return-type="number" class="net-income-form-control mask-money form-control month-target-profit quarter1belong-profit m2targetvalue-profit">`
                    }
                },
                {
                    className: 'w-5',
                    render: (data, type, row) => {
                        ...
                        return `<input ${option==='detail' ? 'disabled readonly' : ''} value="${row.emp_month_target[2] || 0}" data-return-type="number" class="mb-1 mask-money form-control month-target quarter1belong m3targetvalue">
                                <input ${option==='detail' ? 'disabled readonly' : ''} value="${row.emp_month_profit_target[2] || 0}" data-return-type="number" class="net-income-form-control mask-money form-control month-target-profit quarter1belong-profit m3targetvalue-profit">`
                    }
                },
                {
                    className: 'w-5',
                    render: (data, type, row) => {
                        ...
                        return `<input readonly disabled value="${row.emp_quarter_target[0] || 0}" data-return-type="number" class="mb-1 mask-money form-control quarter-target q1targetvalue">
                                <input readonly disabled value="${row.emp_quarter_profit_target[0] || 0}" data-return-type="number" class="net-income-form-control mask-money form-control quarter-target-profit q1targetvalue-profit">`
                    }
                },
                {
                    className: 'w-5',
                    render: (data, type, row) => {
                        ...
                        return `<input ${option==='detail' ? 'disabled readonly' : ''} value="${row.emp_month_target[3] || 0}" data-return-type="number" class="mb-1 mask-money form-control month-target quarter2belong m4targetvalue">
                                <input ${option==='detail' ? 'disabled readonly' : ''} value="${row.emp_month_profit_target[3] || 0}" data-return-type="number" class="net-income-form-control mask-money form-control month-target-profit quarter2belong-profit m4targetvalue-profit">`
                    }
                },
                {
                    className: 'w-5',
                    render: (data, type, row) => {
                        ...
                        return `<input ${option==='detail' ? 'disabled readonly' : ''} value="${row.emp_month_target[4] || 0}" data-return-type="number" class="mb-1 mask-money form-control month-target quarter2belong m5targetvalue">
                                <input ${option==='detail' ? 'disabled readonly' : ''} value="${row.emp_month_profit_target[4] || 0}" data-return-type="number" class="net-income-form-control mask-money form-control month-target-profit quarter2belong-profit m5targetvalue-profit">`
                    }
                },
                {
                    className: 'w-5',
                    render: (data, type, row) => {
                        ...
                        return `<input ${option==='detail' ? 'disabled readonly' : ''} value="${row.emp_month_target[5] || 0}" data-return-type="number" class="mb-1 mask-money form-control month-target quarter2belong m6targetvalue">
                                <input ${option==='detail' ? 'disabled readonly' : ''} value="${row.emp_month_profit_target[5] || 0}" data-return-type="number" class="net-income-form-control mask-money form-control month-target-profit quarter2belong-profit m6targetvalue-profit">`
                    }
                },
                {
                    className: 'w-5',
                    render: (data, type, row) => {
                        ...
                        return `<input readonly disabled value="${row.emp_quarter_target[1] || 0}" data-return-type="number" class="mb-1 mask-money form-control quarter-target q2targetvalue">
                                <input readonly disabled value="${row.emp_quarter_profit_target[1] || 0}" data-return-type="number" class="net-income-form-control mask-money form-control quarter-target-profit q2targetvalue-profit">`
                    }
                },
                {
                    className: 'w-5',
                    render: (data, type, row) => {
                        ...
                        return `<input ${option==='detail' ? 'disabled readonly' : ''} value="${row.emp_month_target[6] || 0}" data-return-type="number" class="mb-1 mask-money form-control month-target quarter3belong m7targetvalue">
                                <input ${option==='detail' ? 'disabled readonly' : ''} value="${row.emp_month_profit_target[6] || 0}" data-return-type="number" class="net-income-form-control mask-money form-control month-target-profit quarter3belong-profit m7targetvalue-profit">`
                    }
                },
                {
                    className: 'w-5',
                    render: (data, type, row) => {
                        ...
                        return `<input ${option==='detail' ? 'disabled readonly' : ''} value="${row.emp_month_target[7] || 0}" data-return-type="number" class="mb-1 mask-money form-control month-target quarter3belong m8targetvalue">
                                <input ${option==='detail' ? 'disabled readonly' : ''} value="${row.emp_month_profit_target[7] || 0}" data-return-type="number" class="net-income-form-control mask-money form-control month-target-profit quarter3belong-profit m8targetvalue-profit">`
                    }
                },
                {
                    className: 'w-5',
                    render: (data, type, row) => {
                        ...
                        return `<input ${option==='detail' ? 'disabled readonly' : ''} value="${row.emp_month_target[8] || 0}" data-return-type="number" class="mb-1 mask-money form-control month-target quarter3belong m9targetvalue">
                                <input ${option==='detail' ? 'disabled readonly' : ''} value="${row.emp_month_profit_target[8] || 0}" data-return-type="number" class="net-income-form-control mask-money form-control month-target-profit quarter3belong-profit m9targetvalue-profit">`
                    }
                },
                {
                    className: 'w-5',
                    render: (data, type, row) => {
                        ...
                        return `<input readonly disabled value="${row.emp_quarter_target[2] || 0}" data-return-type="number" class="mb-1 mask-money form-control quarter-target q3targetvalue">
                                <input readonly disabled value="${row.emp_quarter_profit_target[2] || 0}" data-return-type="number" class="net-income-form-control mask-money form-control quarter-target-profit q3targetvalue-profit">`
                    }
                },
                {
                    className: 'w-5',
                    render: (data, type, row) => {
                        ...
                        return `<input ${option==='detail' ? 'disabled readonly' : ''} value="${row.emp_month_target[9] || 0}" data-return-type="number" class="mb-1 mask-money form-control month-target quarter4belong m10targetvalue">
                                <input ${option==='detail' ? 'disabled readonly' : ''} value="${row.emp_month_profit_target[9] || 0}" data-return-type="number" class="net-income-form-control mask-money form-control month-target-profit quarter4belong-profit m10targetvalue-profit">`
                    }
                },
                {
                    className: 'w-5',
                    render: (data, type, row) => {
                        ...
                        return `<input ${option==='detail' ? 'disabled readonly' : ''} value="${row.emp_month_target[10] || 0}" data-return-type="number" class="mb-1 mask-money form-control month-target quarter4belong m11targetvalue">
                                <input ${option==='detail' ? 'disabled readonly' : ''} value="${row.emp_month_profit_target[10] || 0}" data-return-type="number" class="net-income-form-control mask-money form-control month-target-profit quarter4belong-profit m11targetvalue-profit">`
                    }
                },
                {
                    className: 'w-5',
                    render: (data, type, row) => {
                        ...
                        return `<input ${option==='detail' ? 'disabled readonly' : ''} value="${row.emp_month_target[11] || 0}" data-return-type="number" class="mb-1 mask-money form-control month-target quarter4belong m12targetvalue">
                                <input ${option==='detail' ? 'disabled readonly' : ''} value="${row.emp_month_profit_target[11] || 0}" data-return-type="number" class="net-income-form-control mask-money form-control month-target-profit quarter4belong-profit m12targetvalue-profit">`
                    }
                },
                {
                    className: 'w-5',
                    render: (data, type, row) => {
                        ...
                        return `<input readonly disabled value="${row.emp_quarter_target[3] || 0}" data-return-type="number" class="mb-1 mask-money form-control quarter-target q4targetvalue">
                                <input readonly disabled value="${row.emp_quarter_profit_target[3] || 0}" data-return-type="number" class="net-income-form-control mask-money form-control quarter-target-profit q4targetvalue-profit">`
                    }
                },
                {
                    className: 'w-5',
    ...
    static LoadDetailRevenuePlan(option) {
        ...
        Promise.all([url_loaded]).then(
            (results) => {
                ...
                RevenuePlanPageFunction.getMonthOrder(data?.['period_mapped']?.['space_month'])
