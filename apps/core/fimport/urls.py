...
from apps.core.fimport.views.saledata import (
    ...
    PriceTaxImportAPI, ProductImportAPI, ProductManufacturerImportAPI,
)
...
urlpatterns = [
    ...
    path('saledata/product/manufacturer', ProductManufacturerImportAPI.as_view(), name='ProductManufacturerImportAPI'),
