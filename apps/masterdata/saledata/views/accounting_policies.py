...
class AccountingPoliciesList(View):
    ...
    def get(self, request, *args, **kwargs):
        ...
        return {
            'company_config': resp.result
        }, status.HTTP_200_OK


class AccountingPoliciesListAPI(APIView):
    ...
    def get(self, request, *args, **kwargs):
        ...
        return resp.auto_return(key_success='accounting_policies')
